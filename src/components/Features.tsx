      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Inteligencia Avanzada, <br className="hidden sm:block" />Intuición Humana
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Construido con tecnología de vanguardia para entender, aprender y adaptarse a tus necesidades únicas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Atlas aprende de tus interacciones, mejorando continuamente sus respuestas y acciones para servir mejor tus necesidades."
            index={0}
          />
          <FeatureCard
            ...
            description="Comunícate usando lenguaje natural y gestos. Atlas entiende el contexto y responde apropiadamente."
            index={1}
          />
          <FeatureCard
            ...
            title="Movimiento Preciso"
            description="Articulaciones motorizadas avanzadas proporcionan movimiento fluido y humano con equilibrio y coordinación excepcionales."
            index={2}
          />
          <FeatureCard
            ...
            title="Conciencia Espacial"
            description="Sensores avanzados y tecnología de mapeo permiten a Atlas navegar entornos complejos con facilidad."
            index={3}
          />
          <FeatureCard
            ...
            description="Protocolos integrados protegen tus datos y privacidad, mientras que las salvaguardas físicas aseguran una operación segura."
            index={4}
          />
          <FeatureCard
            ...
            title="Asistencia en Tareas"
            description="Desde recordatorios simples hasta tareas complejas de múltiples pasos, Atlas puede asistir con una amplia gama de actividades."
            index={5}
          />
        </div>
      </div>

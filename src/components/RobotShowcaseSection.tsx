        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            <div className="pulse-chip mb-4">
              ...
              <span>Conoce el Futuro</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4">
              Ingeniería de Precisión se Encuentra con <span className="text-[#FC4D0A]">IA Adaptativa</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Nuestro robot humanoide representa la fusión perfecta de ingeniería mecánica de vanguardia y 
              inteligencia artificial de última generación, diseñado para integrarse perfectamente en entornos humanos.
            </p>
          </div>
          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            <img 
              ...
              alt="Robot humanoide avanzado con exterior blanco" 
              className="w-full object-cover"
            />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white text-xl font-semibold">Compañero de Nueva Generación</h3>
                  <p className="text-white/80">Diseñado para interacción humana</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Sensores Avanzados</h4>
              <p className="text-gray-600">Sensores de alta precisión proporcionan conciencia ambiental en tiempo real y reconocimiento de objetos.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Aprendizaje Adaptativo</h4>
              <p className="text-gray-600">Aprende continuamente de las interacciones para mejorar el rendimiento y personalizar las respuestas.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Movimiento Fluido</h4>
              <p className="text-gray-600">Ingeniería para movimiento natural y humano con altos grados de libertad en todas las articulaciones.</p>
            </div>
          </div>
        </div>
      </div>
